...
namespace Portfolio.Services.Migrations
{
    ...
    [Migration("20260815000511_AddThumbnailToMedia")]
    partial class AddThumbnailToMedia
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Portfolio.Services.Database.Entities.Settings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Key = "site_title",
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 15, 0, 5, 11, 14, DateTimeKind.Unspecified).AddTicks(5685), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "My Portfolio"
                        },
                        new
                        {
                            ...
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 15, 0, 5, 11, 14, DateTimeKind.Unspecified).AddTicks(6196), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 15, 0, 5, 11, 14, DateTimeKind.Unspecified).AddTicks(6199), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 15, 0, 5, 11, 14, DateTimeKind.Unspecified).AddTicks(6201), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 15, 0, 5, 11, 14, DateTimeKind.Unspecified).AddTicks(6202), new TimeSpan(0, 0, 0, 0, 0)),
