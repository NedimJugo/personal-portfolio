...
namespace Portfolio.Services.Migrations
{
    ...
    [Migration("20251005224021_EducationAndCertificate")]
    partial class EducationAndCertificate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Portfolio.Services.Database.Entities.Settings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Key = "site_title",
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 10, 5, 22, 40, 20, 883, DateTimeKind.Unspecified).AddTicks(61), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "My Portfolio"
                        },
                        new
                        {
                            ...
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 10, 5, 22, 40, 20, 883, DateTimeKind.Unspecified).AddTicks(542), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 10, 5, 22, 40, 20, 883, DateTimeKind.Unspecified).AddTicks(545), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 10, 5, 22, 40, 20, 883, DateTimeKind.Unspecified).AddTicks(547), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 10, 5, 22, 40, 20, 883, DateTimeKind.Unspecified).AddTicks(548), new TimeSpan(0, 0, 0, 0, 0)),
