...
namespace Portfolio.Services.Migrations
{
    ...
    [Migration("20260813161905_AddFileDataToMedia")]
    partial class AddFileDataToMedia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Services.Database.Entities.Certificate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Portfolio.Services.Database.Entities.ContactMessageReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Portfolio.Services.Database.Entities.Education", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Portfolio.Services.Database.Entities.Settings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Key = "site_title",
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 13, 16, 19, 5, 71, DateTimeKind.Unspecified).AddTicks(5716), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "My Portfolio"
                        },
                        new
                        {
                            ...
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 13, 16, 19, 5, 71, DateTimeKind.Unspecified).AddTicks(6234), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 13, 16, 19, 5, 71, DateTimeKind.Unspecified).AddTicks(6237), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 13, 16, 19, 5, 71, DateTimeKind.Unspecified).AddTicks(6239), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 13, 16, 19, 5, 71, DateTimeKind.Unspecified).AddTicks(6241), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Portfolio.Services.Database.Entities.Certificate", b =>
                {
                    b.HasOne("Portfolio.Services.Database.Entities.Media", "CertificateMedia")
                        .WithMany()
                    ...
                    b.HasOne("Portfolio.Services.Database.Entities.Media", "LogoMedia")
                        .WithMany()
            ...
            modelBuilder.Entity("Portfolio.Services.Database.Entities.ContactMessageReply", b =>
                {
                    b.HasOne("Portfolio.Services.Database.Entities.ContactMessage", "ContactMessage")
                        .WithMany("Replies")
                    ...
                    b.HasOne("Portfolio.Services.Database.Entities.ApplicationUser", "RepliedBy")
                        .WithMany()
